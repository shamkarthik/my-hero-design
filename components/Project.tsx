...
const Project = () => {
  return (
    <section id="about" className="bg-yellow dark:bg-black">
      {/* <div className="flex relative px-4 items-center overflow-hidden w-full"> */}
      <div className="container grid grid-cols-2 relative py-24 w-screen">
        ...
        <div className="grid grid-flow-row   relative ">
          ...
          <span className="flex text-sm sm:text-base mt-8 text-gray-700 dark:text-white">
            {/* <AnimText
              delay={2}
